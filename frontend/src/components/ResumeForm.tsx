...
export default function ResumeForm() {
  ...
  const handleExport = async () => {
    if (!data.name.trim()) {
      setError("Please enter your name before exporting.");
      return;
    }
  ...
  return (
    <main className="min-h-screen">
      <header className="sticky top-0 z-10 border-b border-gray-200 bg-white/90 backdrop-blur px-6 py-4">
        <div className="mx-auto flex max-w-3xl items-center justify-between">
          <div>
            ...
            <p className="text-xs text-gray-500">
              Fill in your details and download an ATS-friendly Word resume.
            </p>
          </div>
          <button
